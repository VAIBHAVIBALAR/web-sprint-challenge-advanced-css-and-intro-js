...
function get20s(array){
  ...
  for(let i=0; i<array.length; i++){
      ...
      let twoYears = array[i].years.split("-");

    if(twoYears[0] > 1900  &&  twoYears[0] < 2000 && twoYears[1] > 1900 && twoYears[1] < 2000)
      {
      allArtists.push(array[i].name)
      }
  }
  return allArtists;
}
...
function removeArtist(array,i){
   ...
   array.splice(i,1);//removing one artist

   let newArray = array.length;//new array length 
...
function addArtist(array){
    array.push(
      ...
      nationality: "India",
      bio: "I love problem solving tasks"
    })
    return array;
  }
